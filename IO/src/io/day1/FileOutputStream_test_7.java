...
*/	
	...
	public static void main(String[] args) {
		...
		System.out.println(">> 내용을 입력하세요[입력하신 내용은 C:\\NCS\\iotest_data\\result.txt 파일에 저장됨] <<"); 
		
		String fileName = "C:/NCS/iotest_data/result.txt";
		boolean append = true;
...
/*
	...
	java oracle엔터
	Ctrl + C 함
	C:/NCS/iotest_data/result.txt에 쓰기 완료!! 81byte 씀.
	반복회수 : 81번 반복함. 
 */
