...
public class FileCopy_Buffered_test_6 {

	public static void main(String[] args) {  
		
		// "문자로만 이루어진 특정파일" 을 복사를 하고자 한다. 
		try {
			FileManager.charFileCopy_2(args[0], args[1]);
			// args[0] 에 C:/NCS/iotest_data/korea.txt 로 하고,
			// args[1] 에 C:/NCS/iotest_data/korea_copy2.txt 로 하고,
...
/*
    ...
    실행은 명령프롬프트에서 아래와 같이 한다.
    C:\NCS\workspace(java)\IO\bin>java io.day2.b.FileCopy_Buffered_test_6 C:/NCS/iotest_data/korea.txt C:/NCS/iotest_data/korea_copy2.txt      
    
     >>> 파일복사 완료!! <<<
    C:/NCS/iotest_data/korea.txt을 C:/NCS/iotest_data/korea_copy2.txt로 복사완료함!!
